...
def variable_file(firsttrain, callbackperiod, maxepochs, variablefilename):
  ...
  var_list = [callbackcount, E, tp, ti, td, k, Rm, a1, C1, C2, C4, C5, Ub, U0, Um, Rg, alpha, beta]
  var_list_names = ["Epoch","E", "tp", "ti", "td", "k", "Rm", "a1", "C1", "C2", "C4", "C5", "Ub", "U0", "Um", "Rg", "alpha", "beta"]
